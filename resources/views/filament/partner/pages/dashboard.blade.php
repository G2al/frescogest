    ...
    <div class="business-report">
        ...
        <section class="business-report-cards">
            @foreach ([
                ...
                ['revenue_gross', 'Incassi', $summary['revenue_gross'], 'Totale lordo', 'heroicon-o-banknotes', 'is-green'],
                ['waste_amount', 'Scarti', $summary['waste_amount'], 'Perdite registrate', 'heroicon-o-trash', 'is-red'],
                ['expense_amount', 'Spese', $summary['expense_amount'], 'Costi aggiuntivi', 'heroicon-o-receipt-percent', 'is-violet'],
                ['estimated_result', 'Risultato stimato', $summary['estimated_result'], number_format($summary['estimated_margin_percentage'], 1, ',', '.').'% sugli incassi', 'heroicon-o-arrow-trending-up', $summary['estimated_result'] >= 0 ? 'is-green' : 'is-red'],
